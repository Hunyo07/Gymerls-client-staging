...
function Reservation() {
  ...
  const handleOpenModalCreateReservation = () => {
    ...
    fetch("https://gymerls-api-staging.vercel.app/api/user-role-membership")
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      fetch(
        "https://gymerls-api-staging.vercel.app/api/get-reservation-by-date",
        {
          method: "POST",
          headers: {
            "Content-type": "application/json",
  ...
  const filteredDataByStatusAndDate = (status) => {
    ...
    if (status === "All") {
      ...
      fetch(
        "https://gymerls-api-staging.vercel.app/api/get-reservation-by-date-and-status",
        {
          method: "POST",
          headers: {
            "Content-type": "application/json",
  ...
  const updateReservation = (id, date) => {
    ...
    fetch("https://gymerls-api-staging.vercel.app/api/get-reservation-by-id", {
      method: "POST",
      headers: {
        "Content-type": "application/json",
      },
  ...
  const handleUpdateReservation = (event) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch("https://gymerls-api-staging.vercel.app/api/update-reservation", {
          method: "PATCH",
          headers: {
            "Content-type": "application/json",
          },
