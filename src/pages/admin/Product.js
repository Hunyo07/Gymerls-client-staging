...
function Product() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      fetch("https://gymerls-api-staging.vercel.app/api/get-product", {
        method: "POST",
        headers: {
  ...
  const createProduct = (e) => {
    ...
    uploadImageToCloud(function (callback) {
      fetch("https://gymerls-api-staging.vercel.app/api/create-product", {
        method: "POST",
        headers: {
          "Content-type": "application/json",
        },
  ...
  const updateProduct = (e) => {
    ...
    uploadImageToCloud(function (callback) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          fetch("https://gymerls-api-staging.vercel.app/api/update-product", {
            method: "PATCH",
            headers: {
              "Content-type": "application/json",
            },
  ...
  const handleOpenUpdateProduct = (id) => {
    ...
    fetch("https://gymerls-api-staging.vercel.app/api/get-product-by-id", {
      method: "POST",
      headers: {
        "Content-type": "application/json",
      },
