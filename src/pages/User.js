...
function User() {
  ...
  const populateRoleInput = () => {
    fetch("https://gymerls-api-staging.vercel.app/api/roles")
  ...
  const createUser = (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch("https://gymerls-api-staging.vercel.app/api/register", {
          method: "POST",
          headers: {
  ...
  const validateUser = (username) => {
    ...
    if (username.length >= 5) {
      fetch("https://gymerls-api-staging.vercel.app/api/validate-user", {
        method: "POST",
        headers: {
          "Content-type": "application/json",
        },
  ...
  const createUserProfile = () => {
    ...
    fetch("https://gymerls-api-staging.vercel.app/api/create-user-profile", {
      method: "POST",
      headers: {
        "Content-type": "application/json",
      },
        ...
        .then((data) => {
          ...
          for (let item of data) {
            ...
            if (today === membershipEndDate) {
              fetch(
                "https://gymerls-api-staging.vercel.app/api/update-user-status",
                {
                  method: "PATCH",
                  headers: {
                    "Content-type": "application/json",
  ...
  const updateUser = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch("https://gymerls-api-staging.vercel.app/api/update-user", {
          method: "PATCH",
          headers: {
            "Content-type": "application/json",
          },
  ...
  const createMealPlan = (event) => {
    ...
    fetch("https://gymerls-api-staging.vercel.app/api/create-meal-planning", {
      method: "POST",
      headers: {
        "Content-type": "application/json",
      },
  ...
  const updateMealPlan = (event) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(
          "https://gymerls-api-staging.vercel.app/api/update-meal-planning",
          {
            method: "PATCH",
            headers: {
              "Content-type": "application/json",
  ...
  const handleUserStatus = (status, username) => {
    fetch("https://gymerls-api-staging.vercel.app/api/update-user-status", {
      method: "PATCH",
      headers: {
        "Content-type": "application/json",
      },
  ...
  const deleteUser = (username) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch("https://gymerls-api-staging.vercel.app/api/delete-user", {
          method: "PATCH",
          headers: {
            "Content-type": "application/json",
          },
        ...
        fetch(
          "https://gymerls-api-staging.vercel.app/api/delete-user-profile",
          {
            method: "PATCH",
            headers: {
              "Content-type": "application/json",
        ...
        fetch(
          "https://gymerls-api-staging.vercel.app/api/delete-user-meal-plan",
          {
            method: "PATCH",
            headers: {
              "Content-type": "application/json",
        ...
        fetch(
          "https://gymerls-api-staging.vercel.app/api/delete-user-transaction",
          {
            method: "PATCH",
            headers: {
              "Content-type": "application/json",
        ...
        fetch(
          "https://gymerls-api-staging.vercel.app/api/delete-user-reservation",
          {
            method: "PATCH",
            headers: {
              "Content-type": "application/json",
        ...
        fetch("https://gymerls-api-staging.vercel.app/api/delete-user-cart", {
          method: "PATCH",
          headers: {
            "Content-type": "application/json",
          },
